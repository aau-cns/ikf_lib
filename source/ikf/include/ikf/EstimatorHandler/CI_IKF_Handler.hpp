...
class IKF_API CI_IKF_Handler : public IsolatedKalmanFilterHandler {
public:
  CI_IKF_Handler(MultiAgentHdl_ptr pAgentHdler, double const horizon_sec = 1.0);
  ~CI_IKF_Handler() = default;
